...
class Draw:
    ...
    def level_display(self, levelvalue):
        self.canvas.delete(self.level_id)
        self.level_id = self.canvas.create_text(180, 600, fill='black', font="Times 12 bold", text = "Level:{}".format( levelvalue))
    ...
    def display_levelup(self):
        self.canvas.create_text(250, 300, fill='red', font="Times 48 bold", text = "Key found!")
        self.canvas.create_text(250, 380, fill='red', font="Times 20 bold", text = "Press c to enter next level")
