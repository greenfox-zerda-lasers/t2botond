...
var app = express();
app.use(bodyParser.json());//klienstol server fele meg kifele resp.jsonnal ---ey kivaltja server oldalon a json parseokat

app.use(function(req, res, next) { // cors modullal ey kikusyobolheto var cors = require('cors') meg npm install // a body-parser-rel ugyanez
  res.header("Access-Control-Allow-Origin", "*");//cross origin kereseket engedelzeyt
...
app.get('/todos/:id', function a(req, res) { //A linkben a kettospontos lofasy jelzi, hogy lesz egy id valtozo a cmd keresben ezen a helyem.
  // res.set('Content-Type', 'application/json');
  // console.log(list);
///////////////////////////////////////////////  //szimplan res.json is stringifyol
