...
class TestIO(unittest.TestCase):
    ...
    def test_crypto_dup(self):
        self.assertEqual(crypto_1dup.decrypt('D:/greenfox/Greenfox/t2botond/week-04/day-1/01_io/texts/duplicated_chars.txt'),
                         self.load_file_content('D:/greenfox/Greenfox/t2botond/week-04/day-1/01_io/texts/zen_of_python.txt'))

    def test_crypto_revlines(self):
        self.assertEqual(crypto_2revlines.decrypt('D:/greenfox/Greenfox/t2botond/week-04/day-1/01_io/texts/reversed_zen_lines.txt'),
                         self.load_file_content('D:/greenfox/Greenfox/t2botond/week-04/day-1/01_io/texts/zen_of_python.txt'))

    def test_crypto_revorder(self):
        self.assertEqual(crypto_3revorder.decrypt('D:/greenfox/Greenfox/t2botond/week-04/day-1/01_io/texts/reversed_zen_order.txt'),
                         self.load_file_content('D:/greenfox/Greenfox/t2botond/week-04/day-1/01_io/texts/zen_of_python.txt'))

    def test_crypto_encoded(self):
        self.assertEqual(crypto_4encoded.decrypt('D:/greenfox/Greenfox/t2botond/week-04/day-1/01_io/texts/duplicated_chars.txt'),
                         self.load_file_content('D:/greenfox/Greenfox/t2botond/week-04/day-1/01_io/texts/zen_of_python.txt'))
